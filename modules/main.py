...
async def account_login(bot: Client, m: Message):
    editable = await m.reply_text("Hello, **KUNAL**! 🌟\n\n I am your friendly bot 🤖, here to help you download links from your **.txt** file and upload them to Telegram. To get started, simply send me the /txt command and follow a few easy steps.")
